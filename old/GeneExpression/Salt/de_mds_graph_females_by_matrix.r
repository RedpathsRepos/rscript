...
dat<- read.table("Females_MDScoord.txt", header=TRUE, sep="\t", na.strings="?",dec=".", strip.white=TRUE,row.names=1)
...
points(hatch[4,1],hatch[4,2],pch=21,bg="blue")
points(hatch[6,1],hatch[6,2],pch=21,bg="blue")
points(hatch[5,1],hatch[5,2],pch=21,bg="orange")
points(hatch[11,1],hatch[11,2],pch=21,bg="orange")
...
hatch=dat
points(hatch[18,1],hatch[18,2],pch=22,bg="red")
points(hatch[19,1],hatch[19,2],pch=22,bg="red")
points(hatch[13,1],hatch[13,2],pch=22,bg="blue")
points(hatch[22,1],hatch[22,2],pch=22,bg="blue")
points(hatch[14,1],hatch[14,2],pch=22,bg="orange")
points(hatch[23,1],hatch[23,2],pch=22,bg="orange")
points(hatch[17,1],hatch[17,2],pch=22,bg="yellow")
points(hatch[20,1],hatch[20,2],pch=22,bg="yellow")
points(hatch[15,1],hatch[15,2],pch=22,bg="green")
points(hatch[21,1],hatch[21,2],pch=22,bg="green")
points(hatch[16,1],hatch[16,2],pch=22,bg="gray")
points(hatch[24,1],hatch[24,2],pch=22,bg="gray")
